 ...
 *
 */
    use www\system\database\DataBase;
...
class DataBase_pdo extends DataBase {
    ...
    public function __construct($data) {
        ...
        if(!empty($this->data['db_port'])) {
            $this->db = new PDO($this->data['db_type'].':dbname='.$this->data['db_name'].';host='.$this->data['db_host'].$this->data['db_port'].$this->data['db_charset'], $this->data['db_username'], $this->data['db_password']);
        }
        else {
            $this->db = new PDO($this->data['db_type'].':dbname='.$this->data['db_name'].';host='.$this->data['db_host'].$this->data['db_charset'], $this->data['db_username'], $this->data['db_password']);
        }
